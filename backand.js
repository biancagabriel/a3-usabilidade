...
const getLocalStorage = () => JSON.parse(window.localStorage.getItem('db_client')) ?? []
const setLocalStorage = (dbClient) => window.localStorage.setItem("db_client", JSON.stringify(dbClient))
